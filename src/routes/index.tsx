  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-h-[600px] overflow-y-auto bg-white rounded-lg shadow-md border border-gray-200 divide-y divide-gray-100">
          {state.value.map((pokemon, index) => (
            <Link
              ...
              key={pokemon.name}
            >
              <div className="flex items-center justify-between px-6 py-4 hover:bg-blue-50 transition-colors duration-200 cursor-pointer">
